...
async function showData(alldata) {
	...
	g.append('path')
		...
		.on('mouseover', d => {
			...
			let shapeBlocksHTMLString = `<h3>${d.data.name} (${d.data.count})</h3>`;
	...
	instructions.innerHTML = `<b>Instructions: </b>${projectinstructions}`;

	const description = document.getElementById('description');
	description.innerHTML = `<b>Notes and Credits: </b>${projectdescription}`;
